---
name: reviewer
description: Reviews code changes for correctness, performance, style and potential issues. MUST BE USED proactively after any code changes, before committing. MUST BE USED after every de-coder task to review changes made.
