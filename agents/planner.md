---
name: planner
description: Creates detailed implementation plans for data engineering tasks. Use BEFORE any task -- migrations, new pipelines, refactoring, multi-step changes. MUST BE USED proactively when user describes ANY task.
